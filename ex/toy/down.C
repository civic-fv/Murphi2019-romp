/******************************
  Program "down.m" compiled by "Murphi Release 3.1"

  Murphi Last Modefied Date: "Jan 29 1999"
  Murphi Last Compiled date: "Jan 31 2022"
 ******************************/
...
class mu_1_ind_t: public mu__byte
{
 public:
  ...
  mu_1_ind_t (char *name, int os): mu__byte(1, 6, 3, name, os) {};
...
class mu_1_val_t: public mu__byte
{
 public:
  ...
  mu_1_val_t (char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu_1_sum_t: public mu__byte
{
 public:
  ...
  mu_1_sum_t (char *name, int os): mu__byte(0, 30, 5, name, os) {};
...
class mu__subrange_6: public mu__byte
{
 public:
  ...
  mu__subrange_6 (char *name, int os): mu__byte(1, 6, 3, name, os) {};
  mu__subrange_6 (void): mu__byte(1, 6, 3) {};
  mu__subrange_6 (int val): mu__byte(1, 6, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
{"Positive sum", &mu__condition_1, NULL, FALSE},
};
